...
export default function HeroSection() {
    return (
        <>
            <HeroHeader />
            <main id='Home' className="overflow-x-hidden bg-zinc-300">
         <section className=" bg-gradient-to-br from-zinc-300 to-white text-white p-4 pt-32">
  <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-12 px-4 md:px-8">
    ...
    <div className="text-center md:text-left md:w-1/2">
      ...
      <a href="#Resume" className="mt-17 inline-block px-8 py-3 text-sm font-semibold bg-black text-white border-2 border-black rounded-full transition-colors duration-300 hover:bg-black hover:text-zinc-600">
        Resume
      </a>
    </div>
